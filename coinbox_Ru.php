...
$sql = 'SELECT * FROM coin_post  where coin_mind = "Ru" ORDER BY indate DESC';
...
<body>
    ...
    <div class="topnavi_area">
        ...
        <div class="navi_RuSa"><img src="img/TOP_RuON.png" alt=""></div>
        <div class="navi_yajirusi"><a href="coinbox_Sa.php"><img src="img/TOP_RuSaOFF.png" alt=""></a></div>
        <div class="navi_RuSa"><a href="coinbox.php"><img src="img/TOP_SaOFF.png" alt=""></a></div>
    </div>

    <div class="navi_COIN_Ru">
        現在のハッピールビー貯金額は <B><?= $Ru_sum ?> です</B>
    </div>
    <?= $view ?>
